...
namespace Sciencecom.Controllers
{
    ...
    public class DataController : BaseDataController
    {
        ...
        public JsonResult SearchAdvertisingDesign(int page, string sidx, string sord,
            ...
            string Количество_поверхностей, string Площадь_конструкции, string Разреш_по, string НачалоРазреш_по,
...

        {
            ...
            Количество_поверхностей, Площадь_конструкции, Разреш_по, НачалоРазреш_по,
            КонецРазреш_по, Разреш_с, НачалоРазреш_с, КонецРазреш_с, Искать_поверхности);
