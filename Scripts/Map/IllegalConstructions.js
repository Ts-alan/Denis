...
function getReferencesIllegal(role, construction) {
    ...
    if (construction.HasFile1) {
        result += '<br/><a href="/Images/Illegal/' + construction.Id + 'file1.jpg" target="_blank"><img src = "/Images/Illegal/' + construction.Id + 'file1.jpg" height = "180"></a>';
    }
    if (construction.HasFile2) {
        result += '<br/><a href="/Images/Illegal/' + construction.Id + 'file2.jpg" target="_blank"><img src = "/Images/Illegal/' + construction.Id + 'file2.jpg" height = "180"></a>';
    }
    return result;
}
